...
| NVH 数据分析 | 基于 [NvhLibCSharp](https://github.com/GOLDTEAM-BORAY/NvhLibCSharp) 一键分析：时域波形、总声级、平均频谱、1/3 倍频程 |
...
2. 点击工具栏 **数据分析**，勾选步骤后 **运行分析**
3. 自动跳转 **分析报表** 查看 ScottPlot 图表
4. 可 **保存方案** / **加载方案** 复用算法参数

> 需要有效的许可证文件 `license.lic`（随构建输出一同部署）。
